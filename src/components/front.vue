...
export default {
  ...
  methods: {
    head () {
      this.body.head = 'cabeza'
    },
    leftshoulder () {
      this.body.leftshoulder = 'hombro izquierdo'
    },
    rightshoulder () {
      this.body.rightshoulder = 'hombro derecho'
    },
    leftarm () {
      this.body.leftarm = 'brazo izquierdo'
    },
    rightarm () {
      this.body.rightarm = 'brazo derecho'
    },
    chest () {
      this.body.chest = 'pecho'
    },
    stomach () {
      this.body.stomach = 'abdomen'
    },
    leftleg () {
      this.body.leftleg = 'pierna izquierda'
    },
    rightleg () {
      this.body.rightleg = 'pierna derecha'
    },
    lefthand () {
      this.body.lefthand = 'mano derecha'
    },
    righthand () {
      this.body.righthand = 'mano izquierda'
    },
    leftfoot () {
      this.body.leftfoot = 'pie izquierdo'
    },
    rightfoot () {
      this.body.rightfoot = 'pie derecho'
    }
  },
  mounted () {
    vito.index()
